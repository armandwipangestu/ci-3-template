 ...
 *   https://datatables.net/download/#bs4/dt-1.13.4/sp-2.1.2
 *
 * Included libraries:
 *   DataTables 1.13.4, SearchPanes 2.1.2
 */
		...
		var SearchPane = /** @class */ (function () {
			...
			SearchPane.prototype._buildPane = function (
				...
				if (this.s.colExists) {
					...
					for (
						var i = 0, ien = this.s.rowData.arrayFilter.length;
						i < ien;
						i++
					) {
						if (this.s.dt.page.info().serverSide) {
		...
		var SearchPaneST = /** @class */ (function (_super) {
			...
			SearchPaneST.prototype.updateRows = function () {
				...
				for (
					...
					var row = _c[_b];
					row.shown =
						typeof this.s.rowData.binsShown[row.filter] === 'number'
